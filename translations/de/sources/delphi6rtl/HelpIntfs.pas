...
resourcestring
  hNoTableOfContents = 'Inhaltsverzeichnis konnte nicht gefunden werden';
  hNothingFound = 'Für %s sind keine Hilfeinformationen vorhanden.';
  hNoContext = 'Keine kontextsensitive Hilfe installiert';
  hNoTopics = 'Es ist keine themenbasierte Hilfe installiert.';
